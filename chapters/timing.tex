		...
		\subsection{Struttura della cache}
			...
			\begin{table}[]
				...
				\begin{tabular}{|c|c|c|c|c|c|c|} \hline
					...
					Intel		& i$3$-$530$		& $2$	& $2$ x $64$ KB		& $2$ x $512$KB		& $1$ x $4$ MB	& $113$			\\ \hline
								& i$5$-$6685$R		& $4$	& $4$ x $64$ KB		& $4$ x $256$KB		& $1$ x $6$ MB	& $288$			\\ \hline
								& i$7$-$6950$X		& $10$	& $10$ x $64$ KB	& $10$ x $256$KB	& $1$ x $25$ MB	& $1723$		\\ \hline
								& i$9$-$8950$HK		& $6$	& $6$ x $64$ KB		& $6$ x $256$KB		& $1$ x $12$ MB	& $583$			\\ \hline
					AMD			& A$4$ Pro-$3350$B	& $4$	& $4$ x $64$ KB		& $1$ x $2$MB		& -				& -				\\ \hline
								& Athlon $5370$		& $4$	& $4$ x $64$ KB		& $1$ x $2$MB		& -				& $55$			\\ \hline
								& Epyc $7251$		& $8$	& $8$ x $96$ KB		& $8$ x $512$KB		& $32$ MB		& $475$			\\ \hline
				\end{tabular}
			...
			Nella \cref{fig:cachei5} si può vedere l'architettura del processore quadcore Intel Core i$5$-$3470$. La gerarchia delle cache è organizzata in una memoria L$1$ di $64$KB (divisa in $32$KB per le istruzioni e $32$KB per i dati), una memoria L$2$ da $256$KB ed una memoria L$3$ da $6$MB.
