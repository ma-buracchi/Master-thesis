\chapter{SPECTRE attacks}
	...
	\section{L'attacco}
		...
		\subsection{Esempio}
			...
			\begin{itemize}
				\item il valore di x viene scelto in maniera malevola in maniera tale da far puntare \arr{array1}{x} ad un byte segreto \emph{k} che risiede da qualche parte nella memoria della vittima al di fuori di \emph{array1}(\cref{fig:array}).
