	...
	\section{Scenario}
		...
		\section{L'attacco}
			...
			\subsection{Implementazione}
				...
				\begin{figure}
					\begin{center}
						\includegraphics[width=.8\textwidth]{risultati}
